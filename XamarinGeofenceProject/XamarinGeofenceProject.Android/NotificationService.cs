namespace XamarinGeofenceProject.Services
{
    using Android;
    using Android.App;
    ...
    using XamarinGeofenceProject.Droid;
    ...
    public class NotificationsService
    {
        ...
        public void SendNotification(string title, string text, long when)
        {
            try
            {
                ...
                PendingIntent pendingIntent = PendingIntent.GetActivity(context, 0, intent, PendingIntentFlags.OneShot | PendingIntentFlags.Mutable);
        ...
        private Notification CreateNotification(string title, string text, long when, PendingIntent pendingIntent)
        {
            Notification.Builder notificationBuilder = new Notification.Builder(context, "test")
                                .SetLargeIcon(BitmapFactory.DecodeResource(Platform.AppContext.Resources, Android.Resource.Drawable.IcMenuCall))
                                .SetSmallIcon(Android.Resource.Drawable.IcMenuCall)
